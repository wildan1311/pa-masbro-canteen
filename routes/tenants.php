...
Route::prefix('tenant')->middleware(['auth:sanctum', 'tenant'])->name('api.tenant.')->group(function(){
    ...
    Route::put('/order/{id}/accept-reject', [TenantOrderController::class, 'acceptOrRejectOrder']);
});
